...
from ...models import NoticeActionRequest
...
def create_notice(payload: NoticeActionCreate, db: Session = Depends(get_db)) -> NoticeActionResponse:
...
def get_notice(notice_id: UUID, db: Session = Depends(get_db)) -> NoticeActionResponse:
