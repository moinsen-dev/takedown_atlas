    ...
    <html lang="en">
      <body className="bg-[var(--brand-bg)] text-[var(--brand-slate)]">
        <div className="min-h-screen flex flex-col">
          <header className="border-b border-[var(--brand-slate)]/10 bg-white/60 backdrop-blur">
            <div className="mx-auto flex max-w-content items-center justify-between px-6 py-4">
              ...
              <nav className="flex items-center gap-4 text-sm font-medium">
                <Link href="/incidents" className="hover:text-brand-primary">
                  Map
                </Link>
                <Link href="/submit" className="hover:text-brand-primary">
                  Submit
                </Link>
          ...
          <main className="flex-1 bg-[var(--brand-bg)]">{children}</main>
          <footer className="border-t border-[var(--brand-slate)]/10 bg-white/60 text-sm text-brand-slate/70">
            <div className="mx-auto flex max-w-content flex-col gap-3 px-6 py-6 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/usage/brand-guidelines"
                  className="hover:text-brand-primary"
                >
                  Brand
                </Link>
                <Link href="/license" className="hover:text-brand-primary">
                  Licensing
                </Link>
                <Link href="/admin" className="hover:text-brand-primary">
                  Notice &amp; Action
